                ...
                <table id="tableEdit" class="table table-hover table-bordered table-stripped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle"> 6.440 </td>
                            <td style="text-align: center; vertical-align: middle"> 2.610 </td>
                        </tr>
                    </tbody>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 270px; text-align: center;">
                                <input type="text" class="form-control" placeholder="Edit Designator">
                            </td>
