...
<div class="cont col-md-12">
    <form method="post" action="<?php echo base_url();?>index.php/main/edit_project_mitra">
                ...
                <table id="tableEdit" class="table table-responsive table-hover table-bordered table-stripped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="text" class="form-control" name="addIdProject" value="<?php echo $p->id_project; ?>">
                            </td>
                            <td>
                                <input type="text" class="form-control" name="addNameProject" value="<?php echo $p->nama_project; ?>" >
                            </td>
                            <td>
                                <input type="text" class="form-control" name="addNomorSp" value="<?php echo $p->no_sp; ?>">
                            </td>
                            <td>
                                <input type="text" class="form-control" name="addNomorKontrak" value="<?php echo $p->no_kontrak; ?>">
                            </td>
                            <td>
                                <input type="text" class="form-control" name="addTanggalInput" value="<?php echo $p->tanggal_input; ?>">
                            </td>
                            <td>
                                <input type="text" class="form-control" name="addDateLine" value="<?php echo $p->dateline; ?>">
                            </td>
                            <td style="text-align: center; vertical-align: middle;">
