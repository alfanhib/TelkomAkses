                         ...
                         <tbody>
                             <tr>
                                <td style="width: 70px; text-align: center;">
                                    <input type="text" class="form-control" id="upId" placeholder="" name="upId" value="<?php echo $id->no;?>" disabled/>
                                </td>
                 ...
                 <div class="main-foot col-md-12">
                     <div class="row">
                         ...
                         <div class="col-md-4">
                             ...
                             <button class="btn btn-success" id="submit" type="submit"><a name="no" href="<?php echo base_url(); ?>/index.php/main/edit_a/<?php echo $id->no; ?>"><i class="fa fa-upload"></i></a> Upload</button>
                         </div>
                     </div>
                 </div>
            </div>
