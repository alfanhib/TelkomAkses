<form method="post" action="<?php echo base_url();?>index.php/main/edit_harga_tel_b">
                         ...
                         <tbody>
                             <tr>
                                <td style="width: 70px; text-align: center;">
                                    <input type="text" class="form-control" id="upId" placeholder="" name="upId" value="<?php echo $id->no;?>" style="display: none;"/>1
                                </td>
