<form method="post" action="<?php echo base_url();?>index.php/main/edit_harga_tel_a">
             ...
             <div class="main col-md-11">
                ...
                <div class="main-cont">
                     <table id="tableEdit" class="table table-hover table-bordered table-stripped">
                         ...
                         <tbody>
                             <tr>
                                <td style="text-align: center;"><?php echo $id->no; ?></td>
                         ...
                         <tbody>
                             <tr>
                                <td style="width: 70px; text-align: center;">
                                    <input type="text" class="form-control" id="upId" placeholder="" name="upId" value="<?php echo $id->no;?>" style="display: none;"/>
                                </td>
                 ...
                 <div class="main-foot col-md-12">
                     <div class="row">
                         ...
                         <div class="col-md-4"></div>
                         <div class="col-md-4">
                             <a class="btn btn-danger" href="<?php echo base_url();?>index.php/main/harga_telkom"><i class="fa fa-close"></i> Cancel</a>
