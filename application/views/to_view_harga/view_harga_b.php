<div class="cont col-md-12"> 
    <form method="POST" action="<?php echo base_url();?>index.php/main/search_boq_telkom_b" >
            ...
            <div class="main-cont" style="overflow-x : scroll;">
                <table id="tableBoq" class="table table-hover table-bordered table-stripped" style="width: 1700px;">
                    <thead>
                        ...
                        <tr>
                            <td colspan="8">B. Manhole, Perbaikan dan Modifikasi</td>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" style="color: white;" href="<?php echo base_url();?>index.php/main/to_add_boq_tel_b/<?php echo $d->no; ?>"><i class="fa fa-plus"></i> Add</button></a>
                            </td>
                        </tr>
                        <?php 
                                };
