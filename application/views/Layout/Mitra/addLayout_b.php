<form action="<?php echo base_url(); ?>index.php/main/insert_mitra_b" method="post">
                ...
                <div class="main-cont">
                 ...
                 <div class="main-foot col-md-12">
                     <div class="row">
                         ...
                         <div class="col-md-4"></div>
                         <div class="col-md-4">
                             <button  class="btn btn-danger""><a href="<?php echo base_url(); ?>index.php/main/harga_mitra" style="color: white;"><i class="fa fa-close"></i> Cancel</a></button>
                             <input type="submit" name="submit" class="btn btn-success" value="Upload" href="<?php echo base_url(); ?>index.php/main/harga_mitra" />
                         </div>
                     </div>
                 </div>
             </div>
