<div class="cont col-md-12">
        <div class="row">
            <div class="main col-md-12">
                ...
                <div class="col-md-4">
                    <h4>Rincian Harga Satuan Mitra</h4> 
                </div>
                    </div>
                </form>
                </div>
                ...
                <div class="main-cont">
                    <table id="tabelHarga" class="table table-hover table-bordered table-striped">
                        <thead>
                            <tr class="table-title">
                                <th rowspan="2" style="text-align: center; vertical-align: middle;">No</th>
                                <th rowspan="2" style="text-align: center; vertical-align: middle;">Designator</th>
                                <th rowspan="2" style="text-align: center; vertical-align: middle; width: 500px;">Uraian Pekerjaan</th>
                        ...
                        <tbody>
                            ...
                            foreach ($khs as $d){ ?>
                                <tr>
                                    ...
                                    <td style="width: 500px;"><?php echo $d->uraian; ?> </td>
                                    ...
                                    <div class="btn-group">
                                        <a class="btn btn-success btn-sm" href="<?php echo base_url();?>index.php/main/to_edit/<?php echo $d->no; ?>" style="color: white"><i class="fa fa-cog"></i> Edit</a>
                                       <a onclick="return confirm('Apakah Anda Yakin ?')" class="btn btn-danger btn-sm"style="color: white;" href="<?php echo base_url();?>index.php/main/hapus_a/<?php echo $d->no; ?>" ><i class="fa fa-trash-o"></i> Remove</a>
                                    </div>
                                    </td>   
                                </tr>
                            <?php 
                        ...
                        <thead>
                            ...
                            <td>
                                <a class="btn btn-info" style="color: white;" href="<?php echo base_url();?>index.php/main/move_add_b"><i class="fa fa-plus"></i> Add</button></a>
                            </td>
                        </thead>
                        <tbody>
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-success btn-sm" href="<?php echo base_url();?>index.php/main/to_edit_b/<?php echo $f->no; ?>" style="color: white"><i class="fa fa-cog"></i> Edit</a>
                                       <a onclick="return confirm('Apakah Anda Yakin ?')" class="btn btn-danger btn-sm"style="color: white;" href="<?php echo base_url();?>index.php/main/hapus_b/<?php echo $f->no; ?>" ><i class="fa fa-trash-o"></i> Remove</a>
                                    </div>
                                    </td>   
                                </tr>
                            <?php 
                        ...
                        <thead>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" style="color: white;" href="<?php echo base_url();?>index.php/main/move_add_c"><i class="fa fa-plus"></i> Add</button></a>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-success btn-sm" href="<?php echo base_url();?>index.php/main/to_edit_c/<?php echo $c->no; ?>" style="color: white"><i class="fa fa-cog"></i> Edit</a>
                                        <a onclick="return confirm('Apakah Anda Yakin ?')" class="btn btn-danger btn-sm"style="color: white;" href="<?php echo base_url();?>index.php/main/hapus_c/<?php echo $c->no; ?>" ><i class="fa fa-trash-o"></i> Remove</a>
